...
define("tests/spec/input", ["require", "exports", "tests/base", "mocha", "index"], function (require, exports, base_1, mocha_1, index_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    mocha_1.describe("Input Tests", function () {
        mocha_1.it("Input", function () {
            base_1.should(!!index_3.Input, "Input");
        });
        mocha_1.it("OsmSearchProvider", function () {
            base_1.should(!!index_3.OsmSearchProvider, "OsmSearchProvider");
        });
        mocha_1.it("DEFAULT_OPTIONS", function () {
            var options = index_3.Input.DEFAULT_OPTIONS;
            checkDefaultInputOptions(options);
        });
        mocha_1.it("options of an Input instance", function () {
            var input = index_3.Input.create();
